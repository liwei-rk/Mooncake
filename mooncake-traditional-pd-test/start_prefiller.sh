...
# start_prefiller.sh — Start PD Prefiller (kv_producer) — Traditional Mooncake mode
#
# 与 NDS 版的关键区别: 无 NDS_LIBRARY_PATH / MC_NDS_CONFIG 环境变量
...
# Metadata Server 地址 (Mooncake 传统模式也需要)
...
echo "Mode: Traditional Mooncake (file-system)"
