...
extern "C" {
    int32_t init(void *memAddr, uint64_t length);
    int32_t isExists(uint64_t *blockIds, int32_t count);
    int32_t get(uint64_t blockId, uint8_t *blockAddr, size_t offset, size_t length);
    int32_t put(uint64_t blockId, uint8_t *blockAddr, size_t offset, size_t length);
    int32_t batchGet(uint64_t *blockIds, uint8_t **blockAddrs, size_t *offsets,
                     size_t *lengths, int32_t count);
    int32_t batchPut(uint64_t *blockIds, uint8_t **blockAddrs, size_t *offsets,
                     size_t *lengths, int32_t count);
}